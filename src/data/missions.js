...
Complete the code template to pass all checks. The Guardians await your first contract! ⚔️`,
    learningGoal:
      'Create your first Soroban smart contract with a hello function',
    template: `#![no_std]
...
\`\`\``,
    learningGoal:
      'Use persistent storage to create a stateful counter contract',
    template: `#![no_std]
...
impl LedgerContract {
    ...
    checks: [
      ...
      },
      {
        type: 'uses_type',
        typeName: 'Address',
        message: 'Must use the Address type',
      },
      {
        type: 'contains_pattern',
...
\`\`\``,
    learningGoal:
      'Build a basic token with mint, balance, and transfer functions',
    template: `#![no_std]
...
impl TokenContract {
    ...
    checks: [
      ...
      },
      {
        type: 'storage_operation',
        operation: 'set',
        message: 'Must use storage set for balances',
      },
      {
        type: 'storage_operation',
        operation: 'get',
        message: 'Must use storage get for balances',
      },
    ],
    hints: [
...
\`\`\``,
    learningGoal:
      'Implement time-based conditional logic using ledger sequence',
    template: `#![no_std]
use soroban_sdk::{contract, contractimpl, symbol_short, Address, Env, Symbol};
...
\`\`\``,
    learningGoal:
      'Build a multi-signature pact contract with complex state management',
    template: `#![no_std]
use soroban_sdk::{contract, contractimpl, symbol_short, Address, Env, Symbol};
...
impl PactContract {
    ...
    checks: [
      ...
      },
      {
        type: 'storage_operation',
        operation: 'set',
        message: 'Must use storage operations',
      },
    ],
    hints: [
