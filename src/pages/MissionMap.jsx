      ...
      <div className="learning-path">
        ...
        >
          {missionStates.map((m, i) => {
            ...
            const nodeColor = m.completed
              ? '#22c55e'
              : m.unlocked
                ? '#06d6a0'
                : '#374151';
            const textColor = m.completed
              ? '#22c55e'
              : m.unlocked
                ? '#f1f5f9'
                : '#4b5563';
            const glowFilter = m.completed
              ? 'url(#glowGreen)'
              : m.unlocked
                ? 'url(#glowCyan)'
                : '';
              ...
              <g key={m.id}>
                {nextCx !== undefined && (
                  <line
                    ...
                    className={
                      m.completed ? 'path-line completed' : 'path-line'
                    }
                  />
                )}
                <g
