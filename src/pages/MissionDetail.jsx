...
export default function MissionDetail() {
  ...
  useEffect(() => {
    const tourCompleted = localStorage.getItem("soroban_quest_tour_completed");
    ...
    if (!tourCompleted) {
      const driverObj = driver({
        ...
        overlayOpacity: 0.72,
        smoothScroll: true,
        popoverClass: "sq-popover",
        steps: [
          {
            element: "#mission-story",
            popover: {
              title: "Mission Story Panel",
              description:
                "📖 Read the Quest — Each mission tells a story while teaching a Soroban concept. Read it carefully before coding.",
              side: "right",
              align: "start",
              nextBtnText: "Next →",
              prevBtnText: "← Skip",
          ...
          },
          {
            ...
            popover: {
              title: "Code Editor",
              description:
                "⌨️ Write Your Code — This is your code editor with Rust syntax highlighting. Fill in the TODO sections.",
              side: "top",
              align: "start",
              nextBtnText: "Got it →",
              prevBtnText: "← Back",
          ...
          {
            element: "#run-tests-btn",
            popover: {
              title: "Run Tests",
              description:
                "🧪 Validate — Click this button to check your code. Each mission has specific checks that verify your contract.",
              side: "top",
              align: "center",
              nextBtnText: "Next →",
              prevBtnText: "← Skip",
          ...
          },
          {
            ...
            popover: {
              title: "XP & Level",
              description:
                "🏆 Level Up — Complete missions to earn XP, unlock ranks, and collect badges. Track your progress in the Profile page.",
              side: "bottom",
              align: "end",
              nextBtnText: "Start Questing 🚀",
              prevBtnText: "← Back",
            },
          },
        ],
        onDestroyed: () => {
          localStorage.setItem("soroban_quest_tour_completed", "true");
        },
      });
  ...
  return (
    <>
      <div className="mission-detail">
        {/* Story Panel */}
        <div className="mission-story" id="mission-story">
        ...
        {/* Editor Panel */}
        <div className="mission-editor-panel" id="code-editor">
