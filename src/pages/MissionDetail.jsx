  ...
  return (
    <>
      ...
      <div className="mission-detail">
        ...
        <div
          className={`mission-editor-panel ${activeIndex === 0 ? "mobile-hidden" : ""}`}
        >
          <div
            className={`mission-editor-toolbar ${activeIndex === 1 ? "mobile-hidden" : ""}`}
          >
          ...
          <div
            className={`editor-wrapper ${activeIndex === 2 ? "mobile-hidden" : ""}`}
          >
            <Editor
              height="100%"
          ...
          {/* Terminal Panel */}
          <div
            className={`mission-terminal-panel ${activeIndex !== 2 ? "mobile-hidden" : ""}`}
          >
            <div
              className="terminal"
              style={{
