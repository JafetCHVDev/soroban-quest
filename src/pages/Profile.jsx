...
import { loadProgress, exportProgress, importProgress, resetProgress } from '../systems/storage';
  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-header">
        <div className="profile-avatar">{state.level}</div>
          ...
          {completedMissions.map((m) => (
            ...
            >
              <div>
                ...
                <span
                  style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginLeft: '0.75rem' }}
                >
                  Chapter {m.chapter}
                </span>
              </div>
