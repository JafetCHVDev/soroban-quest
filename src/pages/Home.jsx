    ...
    <div>
      <section className="hero">
        ...
        <p className="hero-subtitle">
          Embark on an epic quest to learn Stellar&apos;s smart contract
          platform. Write real Soroban code in your browser, solve challenges,
          and level up your blockchain skills — no installation required.
        </p>
