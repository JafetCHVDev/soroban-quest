...
- Name: profile.spec.ts >> Profile and Data Management >> import button is available on profile page
- Location: e2e\profile.spec.ts:34:3
...
Locator: locator('button:has-text("Import Progress File")')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Import Progress File")')
