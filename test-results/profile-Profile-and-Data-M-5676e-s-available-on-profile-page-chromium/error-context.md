...
- Name: profile.spec.ts >> Profile and Data Management >> export button is available on profile page
- Location: e2e\profile.spec.ts:26:3
...
Locator: locator('button:has-text("Export Progress File")')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Export Progress File")')
