...
- Name: navigation.spec.ts >> Navigation >> homepage loads and navbar links work
- Location: e2e\navigation.spec.ts:12:3
...
Expected substring: "Master"
Received string:    "home.title.lead home.title.brandhome.title.tail"
Timeout: 10000ms

Call log:
  - Expect "toContainText" with timeout 10000ms
  - waiting for locator('h1.hero-title')
    23 × locator resolved to <h1 class="hero-title">…</h1>
       - unexpected value "home.title.lead home.title.brandhome.title.tail"

```

```yaml
- heading "home.title.lead home.title.brand home.title.tail" [level=1]
```
