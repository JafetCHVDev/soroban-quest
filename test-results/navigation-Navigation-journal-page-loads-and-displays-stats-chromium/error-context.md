...
- Name: navigation.spec.ts >> Navigation >> journal page loads and displays stats
...
Locator:  locator('.journal-title')
Expected: "Adventure Journal"
Received: "journal.title"
Timeout:  10000ms

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for locator('.journal-title')
    23 × locator resolved to <h1 class="journal-title">journal.title</h1>
       - unexpected value "journal.title"

```

```yaml
- heading "journal.title" [level=1]
```
